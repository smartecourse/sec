                    ...
                    <table class="table table-bordered thisDisplay" id="dataTableMateri" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th><center>Status Materi</center></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle"><center>{{ ucwords($item->judul_kelas). '-' .$item->tipe_kelas }}</center></td>
                                <td class="align-middle"><center>{{$item->nama_materi}}</center></td>
