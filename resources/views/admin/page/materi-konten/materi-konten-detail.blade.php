                    ...
                    <table class="table table-bordered thisDisplay" id="dataTable" width="100%" cellspacing="0">
                        <tbody>
                            <tr>
                                ...
                                <td>{{ strtoupper($getMateri->tipe_kelas) }} {{$getMateri->judul_kelas}} - {{$getMateri->nama_jenis_kelas}}</td>
                            </tr>
                            <tr>
                                <th class="w-25">Materi</th>
                                <td>{{$getMateri->nama_materi}}</td>
                            </tr>
                            <tr>
                                <th class="w-25">Judul Konten Materi</th>
                                <td>{{$getMateri->judul_konten_materi}}</td>
                            </tr>
                            <tr>
                                <th class="w-25">Deskripsi</th>
                                <td>{!! $getMateri->deskripsi !!}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>{{$getMateri->urutan}}</td>
                            </tr>
                            <tr>
                                <th class="w-25">Status Materi</th>
                                <td>{{$getMateri->is_active}}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
