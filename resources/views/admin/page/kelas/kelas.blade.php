        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered thisDisplay" id="dataTableKelas" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th><center>Tipe Kelas</center></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle"><center>{{$item->kode_kelas}}</center></td>
                                <td class="align-middle"><center>{{ ucwords($item->judul_kelas) }}</center></td>
                                <td class="align-middle"><center>{{ strtoupper($item->nama_jenis_kelas) }}</center></td>
                                <td class="align-middle"><center>{{ strtoupper($item->tipe_kelas) }}</center></td>
