...
<head>
    ...
    <title>Reset Password - SEC</title>
        ...
        <div class="col-lg-5 col-md-12 col-sm-12 shadow mb-5 bg-body rounded card p-5" style="border: none">
          ...
          <form action=" {{ route('password.email') }} " method="post">
            ...
            <div class="form-group">
              ...
              <input id="email" class="form-control @error('email') is-invalid @enderror" type="email" name="email" value="{{ old('email') }}"  required autocomplete="email" autofocus placeholder="Exp:user@gmail.com">
            @error('email')
            ...
            <div class="mt-4">
                <button type="submit" class="btn btn-primary w-100 btn-masuk text-uppercase">Reset Password</button>
            </div>
          </form>
        </div>
      </div>
