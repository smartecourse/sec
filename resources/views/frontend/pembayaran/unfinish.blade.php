    ...
    <main class="finish-payment">
        <div class="container my-5">
            <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 d-flex justify-content-center">
              <div class="col-lg-6 col-md-12 p-3 p-lg-5 pt-lg-5 rounded shadow-lg card-unfinish">
                  <div class="d-flex justify-content-center mt-5">
                    <img src="{{ asset('frontend/assets/icon/unfinish-icon.svg') }}" class="img-fluid w-50" alt="" srcset="">
                  </div>

                <h1 class="display-6 fw-bold lh-1 text-center p-4 mt-5 text-warning text-unfinish">Pembayaran Sukses</h1>
